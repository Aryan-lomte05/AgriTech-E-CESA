...
// Mobile Sponsor Card
const MobileSponsorCard = memo(({ sponsor, index }) => {
  return (
    <motion.div
      className="glass-card p-4 rounded-2xl border-2 border-lime-400/20 hover:border-lime-400 transition-all"
    ...
    >
      ...
      <p className="text-center text-xs text-gray-400 mt-2 font-semibold">{sponsor.name}</p>
    </motion.div>
  );
});

MobileSponsorCard.displayName = 'MobileSponsorCard';
...
const Sponsors = () => {
  ...
  return (
    <div className="relative section-container py-24 overflow-hidden bg-gradient-to-b from-neutral-900 via-black to-neutral-900">
      ...
      <motion.p 
        className="text-center text-gray-300 mb-16 text-lg md:text-xl font-light relative z-10 px-4"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ delay: 0.2 }}
      ...
      <div className="hidden md:block space-y-10 relative z-10">
        {/* First Row */}
        <div className="relative overflow-hidden py-6">
          <motion.div
            className="flex gap-10 items-center"
      ...
      {/* MOBILE - Static Grid */}
      <div className="md:hidden grid grid-cols-2 gap-4 max-w-md mx-auto px-4 relative z-10">
      ...
      >
        ...
        <motion.a
          href="mailto:eesa.engg@somaiya.edu"
          className="inline-flex items-center gap-2 md:gap-3 btn-primary px-8 py-4 md:px-10 md:py-5 text-lg md:text-xl font-bold"
          whileHover={{ scale: 1.08, boxShadow: "0 0 40px rgba(168, 255, 0, 0.6)" }}
          whileTap={{ scale: 0.95 }}
          animate={{
            y: [0, -5, 0],
