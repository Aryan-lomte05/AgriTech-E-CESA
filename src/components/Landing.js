...
//       {/* Celestial Body - FIXED */}
//       <motion.div
//         className="absolute top-16 md:top-20 right-12 md:right-20 w-24 h-24 md:w-32 md:h-32 lg:w-48 lg:h-48 z-10"
//         animate={{
//           y: [0, -30, 0],
//           rotate: isNight ? [0, 360] : 0,
//         }}
//         transition={{
//           y: { duration: 8, repeat: Infinity, ease: "easeInOut" },
//           rotate: isNight ? { duration: 50, repeat: Infinity, ease: "linear" } : { duration: 0 },
//         }}
//       >
//         <img
//           src={isNight ? Moon : Sun}
...
//           style={{
//             filter: isNight
//               ? "drop-shadow(0 0 40px rgba(168, 255, 0, 0.6)) brightness(1.2)"
//               : "drop-shadow(0 0 60px rgba(255, 200, 0, 0.6))",
//           }}
//         />
//       </motion.div>
...
//             src={Comet}
//             alt="Comet"
//             className="absolute w-20 h-20 md:w-24 md:h-24 z-5"
//             initial={{ x: "-100%", y: "10%", opacity: 0 }}
//             animate={{
//               x: "120vw",
//               y: "60%",
...
//       {/* Content */}
//       <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-6 pt-20 md:pt-0">
//         <motion.div
...
//             transition={{ duration: 3, repeat: Infinity }}
//           >
//             <h3 className="text-sm md:text-lg lg:text-xl font-medium tracking-wider text-lime-400/90">
//               <span className="font-bold">K.J. Somaiya School of Engineering</span>
//               {' '}<span className="text-gray-500">|</span>{' '}
//               <span className="font-bold text-emerald-400">e-CESA</span>
//             </h3>
//             <p className="text-base md:text-lg lg:text-xl font-light text-white/60">
//               Presents
//             </p>
//           </motion.div>
...
//           {/* Title */}
//           <motion.h1
//             className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight gradient-text leading-tight"
//             style={{
//               filter: "drop-shadow(0 0 20px rgba(168, 255, 0, 0.3))",
//             }}
//           >
...
//       <motion.button
//         onClick={toggleTheme}
//         className="fixed bottom-20 md:bottom-24 right-6 md:right-8 z-50 w-12 h-12 md:w-14 md:h-14 glass-card flex items-center justify-center hover:bg-white/20 transition-all duration-300 border-2 border-lime-400/30"
//         whileHover={{ scale: 1.15, rotate: 180 }}
//         whileTap={{ scale: 0.9 }}
//         aria-label="Toggle theme"
//       >
//         <span className="text-xl md:text-2xl">{isNight ? "🌙" : "☀️"}</span>
//       </motion.button>
...
const Landing = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-neutral-950">
      ...
      {/* Content - COLLEGE NAME LOWERED & BIGGER */}
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-6 pt-32 md:pt-24">
        <motion.div
          className="text-center space-y-6 md:space-y-8"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.5 }}
        >
          {/* Branding - LOWER & BIGGER FONT */}
          <motion.div
            className="space-y-2 mb-6"
            animate={{ scale: [1, 1.02, 1] }}
            transition={{ duration: 3, repeat: Infinity }}
          >
            <h3 className="text-base md:text-xl lg:text-2xl xl:text-3xl font-bold tracking-wide text-lime-400 drop-shadow-lg px-4">
              K.J. Somaiya School of Engineering
              <span className="text-gray-400 mx-2">|</span>
              <span className="text-emerald-400">e-CESA</span>
            </h3>
            <p className="text-base md:text-lg lg:text-xl font-light text-white/70">
              Presents
            </p>
          </motion.div>
